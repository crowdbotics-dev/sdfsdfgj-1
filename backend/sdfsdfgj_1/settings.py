"""
Django settings for sdfsdfgj_1 project.
...
WSGI_APPLICATION = 'sdfsdfgj_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sdfsdfgj_1 API",
    "DESCRIPTION": "API documentation for sdfsdfgj_1 App",
    "VERSION": "v1",
}
